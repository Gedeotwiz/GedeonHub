        ...
        <div className='w-2/5'>
          ...
          >
            ...
            <p className='text-2xl'>
              ...
              experience of {totalYear}
              years in both frontend and backend development. I enjoy solving
              problems, learning new technologies, and collaborating on
              impactful projects.
            </p>
          </motion.div>
          ...
          <div className='flex justify-start items-center gap-5 py-5'>
            {cards.map((card, index) => (
              <div
                key={index}
                className='bg-background transition border-1 hover:bg-[#d9a10617] border-black hover:border-primary rounded-md w-[200px] h-[100px] flex flex-col gap-2 justify-center items-center'
              >
