...
export default function Home() {
  return (
    <>
      <div className="flex flex-col-reverse gap-10 lg:gap-0 lg:flex-row justify-center items-center">
        ...
        <div className=' w-full md:w-[80%] lg:w-[40%] self-center'>
      ...
      '
        ...
        <div className='absolute z-50 right-1/10 bottom-10 flex flex-col gap-4 justify-center items-center'>
